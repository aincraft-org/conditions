...
import net.aincraft.condition.AllOfCondition;
import net.aincraft.condition.AlwaysCondition;
import net.aincraft.condition.AnyOfCondition;
import net.aincraft.condition.BiomeCondition;
...
import net.aincraft.condition.FluidCondition;
import net.aincraft.condition.InvertedCondition;
import net.aincraft.condition.JobCondition;
import net.aincraft.condition.PlayerResourceCondition;
import net.aincraft.condition.PlayerResourceType;
import net.aincraft.condition.PotionAmplifierCondition;
import net.aincraft.condition.PotionDurationCondition;
import net.aincraft.condition.PotionPresentCondition;
import net.aincraft.condition.RelationalOperator;
import net.aincraft.condition.SneakingCondition;
import net.aincraft.condition.SprintingCondition;
import net.aincraft.condition.WeatherCondition;
import net.aincraft.condition.WeatherState;
import net.aincraft.condition.WorldCondition;
